...
void setup() {
{
  ...
  Serial.println("pitch, roll, yaw, WS 01, WS 02, WS 03, Dust density");
...
void loop() 
{
  ...
  calcVoltage = voMeasured * (3.3 / 1023);
...
if(myFile) {
   ...
   myFile.print("yaw: ");
   myFile.println(yaw);
   myFile.print("X_Wind Speed: ");
   myFile.println((float)WindSpeed_MPH1);
   myFile.print("Y_Wind Speed: ");
   myFile.println((float)WindSpeed_MPH2);
   myFile.print("Z_Wind Speed: ");
   myFile.println((float)WindSpeed_MPH3);
   myFile.print("Dust density: ");
   myFile.println(dustDensity); // unit: mg/m^3
